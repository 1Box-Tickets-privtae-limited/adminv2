...
function get_admin_role($admin_id)
  ...
  function get_unpaid_orders($where = array())
	...
	{ 
		$this->db->select('booking_global.bg_id,booking_global.partner_id,booking_global.seller_id,booking_global.affiliate_id,booking_global.booking_no,booking_global.booking_status,booking_tickets.match_name,booking_tickets.quantity,booking_tickets.currency_type,booking_global.ticket_amount,booking_global.partner_commission,booking_billing_address.title,booking_billing_address.first_name,booking_billing_address.last_name,ticket_types_lang.name as ticket_type_name');
