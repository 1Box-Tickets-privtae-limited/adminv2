...
<script type="text/javascript">
      $(document).ready(function(){
         ...
         bulmaCalendar.attach("#bulma-datepicker-1", { dateFormat: "YYYY-MM-DD" ,startDate: new Date('<?php echo "2023-01-01";?>'), color: themeColors.primary, lang: "en",showHeader: false,
            showButtons: false,
            showFooter: false });
