						...
						<input type="hidden" name="city_id" value="<?php if (isset($city_details->id)) {
						 ...
						 <div class="col-lg-3">
							...
							<div class="col-lg-3" style="display:none">
								...
								<input required type="text" name="cityname" id="cityname" class="form-control" placeholder="Enter City Name" value="<?php  if (isset($city_details->name)) { echo $city_details->name; } ?>">
								</div> 
							</div> 
